...
judgmentType: multi
summary: A moderation model beats the old rules engine on a vendor benchmark, but the benchmark labels may be measuring vendor behavior more than policy truth.
skills:
  - label quality audit
